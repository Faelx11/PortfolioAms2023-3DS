...
class LearPlusApp(App):
 ...
 # Campos de entrada
        ...
        atualizar_button = Button(text="",
                              font_size=0,
                              background_normal="py.kivy/py/img_wireframe/ICONS/adm.secretaria/deixar-de-seguir.png",
                              background_down="py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(50, 50))
        ...
        inativar_button = Button(text="",
                              font_size=0,
                              background_normal="py.kivy/py/img_wireframe/ICONS/adm.secretaria/atualizar.png",
                              background_down="py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(50, 50))
